...
def test_research_object_is_not_a_valid_file_article():
...
def test_thesis_dissertation_is_not_a_valid_file_article():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/article.json/#/definitions/Article',
...
def test_dataset_is_not_a_valid_file_article():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/article.json/#/definitions/Article',
...
def test_information_package_is_not_a_valid_file_article():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/article.json/#/definitions/Article',
