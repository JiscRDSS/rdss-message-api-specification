from ..test_helpers import load_json, valid_file_against_schema, invalid_file_against_schema, invalid_against_schema


def test_thesis_dissertation_is_valid():
...
def test_thesis_dissertation_without_awarded_date_is_invalid():
...
def test_thesis_dissertation_without_awarding_institution_is_invalid():
    message_body = load_json(
        '../messages/body/metadata/create/thesis_dissertation_create_request.json')
...
def test_article_is_not_a_valid_thesis_dissertation():
...
def test_research_object_is_not_a_valid_thesis_dissertation():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/thesis_dissertation.json/#/definitions/ThesisDissertation',
...
def test_dataset_is_not_a_valid_thesis_dissertation():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/thesis_dissertation.json/#/definitions/ThesisDissertation',
...
def test_information_package_is_not_a_valid_thesis_dissertation():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/thesis_dissertation.json/#/definitions/ThesisDissertation',
