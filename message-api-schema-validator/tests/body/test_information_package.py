...
def test_information_package_is_valid():
...
def test_research_object_is_not_a_valid_information_package():
...
def test_article_is_not_a_valid_information_package():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/information_package.json/#/definitions/InformationPackage',
...
def test_thesis_dissertation_is_not_a_valid_information_package():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/information_package.json/#/definitions/InformationPackage',
...
def test_dataset_is_not_a_valid_information_package():
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/information_package.json/#/definitions/InformationPackage',
