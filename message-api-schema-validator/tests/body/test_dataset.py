...
def test_dataset_is_valid(valid_file_against_schema):
...
def test_article_is_not_a_valid_dataset(invalid_file_against_schema):
...
def test_thesis_dissertation_is_not_a_valid_dataset(invalid_file_against_schema):
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/dataset.json/#/definitions/Dataset',
...
def test_research_object_is_not_a_valid_dataset(invalid_file_against_schema):
    invalid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/dataset.json/#/definitions/Dataset',
