...
def test_thesis_dissertation_is_not_a_valid_research_object(invalid_against_schema):
    invalid_against_schema(
            "https://www.jisc.ac.uk/rdss/schema/research_object.json/#/definitions/ResearchObject",
            "../messages/body/metadata/create/thesis_dissertation_create_request.json"
            )

def test_dataset_is_not_a_valid_research_object(invalid_against_schema):
    invalid_against_schema(
            "https://www.jisc.ac.uk/rdss/schema/research_object.json/#/definitions/ResearchObject",
