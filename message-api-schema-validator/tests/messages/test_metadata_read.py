def test_metadata_read_request_is_valid(valid_file_against_schema):
...
def test_metadata_read_article_response_is_valid(valid_file_against_schema):
    valid_file_against_schema(
...
def test_metadata_read_dataset_response_is_valid(valid_file_against_schema):
    valid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/message/metadata/read_response.json/#/definitions/MetadataReadResponse',
...
def test_metadata_read_research_object_response_is_valid(valid_file_against_schema):
    valid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/message/metadata/read_response.json/#/definitions/MetadataReadResponse',
...
def test_metadata_read_thesis_dissertation_response_is_valid(valid_file_against_schema):
    valid_file_against_schema(
        'https://www.jisc.ac.uk/rdss/schema/message/metadata/read_response.json/#/definitions/MetadataReadResponse',
